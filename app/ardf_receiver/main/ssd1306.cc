...
void SSD1306::Setup(const uint8_t address) {
  ...
  prev_buffer_ = new uint8_t[kBufferSize];
  memset(prev_buffer_, 0xFF, kBufferSize);  // Force first display
...
void SSD1306::Display() {
  ...
  if (memcmp(buffer_, prev_buffer_, kBufferSize) == 0) {
    return;
  }
  ...
  WriteData(buffer_, kBufferSize);
  memcpy(prev_buffer_, buffer_, kBufferSize);
}
...
void SSD1306::DrawString(int16_t x, int16_t y, const char* str, bool color, uint8_t size) {
  int16_t cursor_x = x;
  int16_t cursor_y = y;
...
static const uint16_t font10x14_0[] = {
    0x0FFC, 0x1FFE, 0x3003, 0x3003, 0x3003, 0x3003, 0x3003, 0x3003, 0x1FFE, 0x0FFC,
};
static const uint16_t font10x14_1[] = {
    0x0000, 0x1000, 0x3004, 0x3006, 0x3FFF, 0x3FFF, 0x3000, 0x3000, 0x1000, 0x0000,
};
// '2':  ..XXXXXX..   '3':  ..XXXXXX..
//       .XXXXXXXX.         .XXXXXXXX.
//       XX......XX         XX......XX
...
static const uint16_t font10x14_2[] = {
    0x3804, 0x3806, 0x3403, 0x3603, 0x3303, 0x3183, 0x30C3, 0x3063, 0x303E, 0x301C,
};
static const uint16_t font10x14_3[] = {
    0x0C04, 0x1C06, 0x3003, 0x3063, 0x3063, 0x3063, 0x3063, 0x3063, 0x1FFE, 0x0F9C,
};
// '4':  ......XX..   '5':  XXXXXXXXXX
//       .....XXX..         XXXXXXXXXX
//       ....XXXX..         XX........
...
static const uint16_t font10x14_4[] = {
    0x03C0, 0x03E0, 0x0330, 0x0318, 0x030C, 0x0306, 0x3FFF, 0x3FFF, 0x0300, 0x0300,
};
static const uint16_t font10x14_5[] = {
    0x0C3F, 0x1C3F, 0x3033, 0x3033, 0x3033, 0x3033, 0x3033, 0x3033, 0x1FE3, 0x0FC3,
};
...
static const uint16_t font10x14_6[] = {
    0x0FFC, 0x1FFE, 0x3063, 0x3063, 0x3063, 0x3063, 0x3063, 0x3063, 0x1FC6, 0x0F84,
};
static const uint16_t font10x14_7[] = {
    0x0003, 0x0003, 0x3C03, 0x3F03, 0x03C3, 0x00E3, 0x0033, 0x001B, 0x000F, 0x0007,
};
// '8':  ..XXXXXX..   '9':  ..XXXXXX..
//       .XXXXXXXX.         .XXXXXXXX.
//       XX......XX         XX......XX
...
static const uint16_t font10x14_8[] = {
    0x0F9C, 0x1FFE, 0x3063, 0x3063, 0x3063, 0x3063, 0x3063, 0x3063, 0x1FFE, 0x0F9C,
};
static const uint16_t font10x14_9[] = {
    0x0C3C, 0x1C7E, 0x30C3, 0x30C3, 0x30C3, 0x30C3, 0x30C3, 0x30C3, 0x1FFE, 0x0FFC,
};
// '.'  (rows 12-13 only)
...
static const uint16_t font10x14_M[] = {
    0x3FFF, 0x3FFF, 0x0006, 0x000C, 0x0018, 0x0018, 0x000C, 0x0006, 0x3FFF, 0x3FFF,
};
static const uint16_t font10x14_H[] = {
    0x3FFF, 0x3FFF, 0x0060, 0x0060, 0x0060, 0x0060, 0x0060, 0x0060, 0x3FFF, 0x3FFF,
};
...
static const uint16_t font10x14_z[] = {
    0x3060, 0x3060, 0x3860, 0x3C60, 0x3660, 0x3360, 0x31E0, 0x30E0, 0x0000, 0x0000,
};
...
static const uint16_t* GetLargeFontGlyph(char c) {
  switch (c) {
    case '0': return font10x14_0;
    case '1': return font10x14_1;
    case '2': return font10x14_2;
    case '3': return font10x14_3;
    case '4': return font10x14_4;
    case '5': return font10x14_5;
    case '6': return font10x14_6;
    case '7': return font10x14_7;
    case '8': return font10x14_8;
    case '9': return font10x14_9;
    case '.': return font10x14_dot;
    case 'M': return font10x14_M;
    case 'H': return font10x14_H;
    case 'z': return font10x14_z;
    default:  return font10x14_space;
  }
}
...
void SSD1306::DrawLargeString(int16_t x, int16_t y, const char* str, bool color) {
  int16_t cursor_x = x;
...
void SSD1306::DrawBatteryIcon(int16_t x, int16_t y, int16_t fill_level,
  ...
  DrawRect(x + kBatteryTerminalWidth, y,
           kBatteryBodyWidth, kBatteryBodyHeight, color);
  ...
  if (fill_level > 0) {
    ...
    int16_t fill_x = x + kBatteryTerminalWidth + 1 + (kBatteryFillMax - fill_level);
...
void SSD1306::DrawBadge(int16_t x, int16_t y, int16_t w, int16_t h,
                        const char* /*text*/) {
...
void SSD1306::WriteData(const uint8_t* data, size_t len) {
  ...
  for (size_t i = 0; i < len; i += kDataChunkSize) {
    ...
    size_t current_chunk = (remaining > kDataChunkSize) ? kDataChunkSize : remaining;
    ...
    esp_err_t ret = i2c_master_transmit(dev_handle_, write_buf, current_chunk + 1,
                                        i2c_util::kI2cTimeoutMs);
    if (ret != ESP_OK) {
      ESP_LOGE(kTag, "SSD1306 data write failed at offset %zu: %s", i, esp_err_to_name(ret));
      break;
    }
  }
}
