...
constexpr uint32_t kI2cFrequencyHz = 100000;  // 100kHz standard mode (for stability)
...
constexpr int16_t kSmeterBarX = 14;           // Bar starts after "S9" text (2 chars * 6px + 2px gap)
constexpr int16_t kSmeterBarY = 25;
constexpr int16_t kSmeterBarWidth = 66;
constexpr int16_t kSmeterBarHeight = 6;
constexpr int16_t kSmeterBarInnerMax = 64;    // Max fill width (bar_width - 2 for border)
...
constexpr int16_t kVolumeBarInnerMax = 34;    // Max fill width (bar_width - 2 for border)
...
constexpr int16_t kCursorLabelX = 11;         // Cursor label after icon (8px icon + 3px gap)
